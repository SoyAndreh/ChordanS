document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById("vaciar-carrito").addEventListener("click", function () {
    ...
    actualizarTotal(0); // Al vaciar el carrito, establece el total a 0
  });
});
...
function mostrarProductosEnCarrito(productos) {
      ...
      <div class="col-md-4 mb-3">
        <div class="card">
          <div class="card-body">
            ...
            <button class="btn btn-danger btn-eliminar" data-nombre="${producto.nombre}">
  ...
  actualizarTotal(total); // Actualiza el total después de mostrar los productos
...
function actualizarTotal(total) {
  const totalElemento = document.getElementById("total-a-pagar");
